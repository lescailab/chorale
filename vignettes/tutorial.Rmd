...
<p>Two biological programmes recovered across three cohorts that share no samples, each with a
...
modality: a cohort of seventy samples will not support many components, and asking for more
...
Each individual was measured once, so how strongly two programmes move together *within* an
individual is
